...
//cambiameto di dimensione ad ogni passo
int stepSize = 2;
//distorsione
...
void setup(){
  ...
  // init form centro dello schermo
  centerX = width/2; 
  centerY = height/2;
...
void draw(){
  // tratto verso la posizione del mouse
...
// se premi il mouse si può iniziare un nuovo tracciato
void mousePressed() {
  centerX = mouseX; 
  centerY = mouseY;
  float angle = radians(360/float(formResolution));
...
//per salvare immagini o csncellare tutto sullo schermo
void keyReleased() {
